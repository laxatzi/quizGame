{
  ...
  // nested functions
       ...
       function ask(questionCurrent) {
         ...
         update($question,quiz.questionCore + questionCurrent.question + "?");
         ...
         function chooseOption() {
           const option = quiz.questions[random(quiz.questions.length) - 1];
       ...
       function check(answer) {
        ...
        // add a 3rd arg to style as we wish (remember third param in update is klass)
